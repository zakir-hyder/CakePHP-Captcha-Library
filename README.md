...
CakePHP 2.1 :Put the "captcha" folder on path-to-cakephp-2.0/vendors/ Ð on root vendors folder. Use following
...
CakePHP 2.0 :Put the ÒcaptchaÓ folder on path-to-cakephp-2.0/app/vendors/  on AppÕs vendors folder. Use following

    App::import('Vendor', 'captcha/captcha');

CakePHP 1.3 :Put the ÒcaptchaÓ folder on path-to-cakephp-1.3/vendors/ on the root vendors folder.

    App::import('Vendor', 'captcha/captcha');

CakePHP 1.2 :This post and code is for CakePHP 1.2 and CakePHP 1.3. For CakePHP 1.3 put the "captcha" folder on path-to-cakephp-1.3/vendors/ Ð
